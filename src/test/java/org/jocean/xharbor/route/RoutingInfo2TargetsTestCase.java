...
import org.jocean.xharbor.route.RoutingInfo2Targets.Level;
import org.junit.Test;

public class RoutingInfo2TargetsTestCase {
    ...
    public void testRoutingInfo2URIsClone() throws Exception {
        final RoutingInfo2Targets r1 = new RoutingInfo2Targets();
        ...
        final RoutingInfo2Targets r2 = r1.clone();
        assertEquals(r1, r2);
